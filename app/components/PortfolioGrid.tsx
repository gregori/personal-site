...
const placeholderProjects = [
  ...
  },
  {
    ...
    color: "from-accent-purple/20 to-accent/10",
  },
  {
    title: "Research & Teaching",
    tag: "Coming Soon",
    desc: "Academic work in AI, systems security, and software engineering",
    color: "from-accent/10 to-accent-purple/20",
  },
];
...
function ProjectCard({
  ...
  return (
    ...
    >
      {/* Gradient overlay */}
      <div
        className={`absolute inset-0 bg-gradient-to-br ${project.color} opacity-30 transition-opacity duration-500 group-hover:opacity-50`}
      />
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6">
        ...
        <div className="reveal reveal-delay-4 mt-12 text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-dashed border-card-border px-5 py-2.5 text-sm text-muted">
            ...
            More projects are being added — check back soon
          </div>
        </div>
      </div>
    </section>
